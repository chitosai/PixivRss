...
regx = '<a href="member_illust\.php\?mode=medium&amp;illust_id=(\d+)[^"]+" class="work"><img src="([^"]+)" class="_thumbnail"></a><div class="data"><h2><a href="[^"]+" class="title">(.+?)</a></h2><a href="[^"]+" class="user-container"><img class="user-icon ui-scroll-view" data-filter="lazy-image" data-src="[^"]+" src="http://source\.pixiv\.net/www/images/common/transparent\.gif" height="32"><span class="icon-text">(.+?)</span></a><dl class="inline-list slash-separated"><dt>阅览数</dt><dd>(\d+)</dd><dt>总分</dt><dd>(\d+)</dd></dl><dl class="inline-list"><dt>投稿日期</dt><dd>(.+?)</dd></dl>'
